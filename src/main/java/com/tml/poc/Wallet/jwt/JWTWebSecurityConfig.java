...
/**
 * class is use for Web Security Config 
 * config everytime when App Start
...
public class JWTWebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity webSecurity) throws Exception {
        ...
        webSecurity.ignoring().antMatchers(HttpMethod.GET,"/swagger.json");
        webSecurity.ignoring().antMatchers(HttpMethod.GET,"/swagger-ui.html");
        webSecurity.ignoring().antMatchers(HttpMethod.GET,"/swagger-resources/**");
        webSecurity.ignoring().antMatchers(HttpMethod.GET,"/v2/api-docs");
